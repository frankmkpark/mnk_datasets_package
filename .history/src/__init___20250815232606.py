# src/__init__.py
"""
Unified public API for the MNK datasets (flat layout).

Subpackages expected:
- kbo_npb
- kbo_npb_mlb
- mnk_merged
- mnk_merged_tall

Each subpackage must implement:
  - list_csv() -> list[str]
  - load_csv(csv_name: str, **read_csv_kwargs) -> pandas.DataFrame
"""
...
# Human-friendly names -> python package module
