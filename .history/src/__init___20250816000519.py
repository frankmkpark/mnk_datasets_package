...
from kbo_npb_mlb.api import (
    load_kbo_batting as load_kbo_batting_v2,
    load_kbo_pitching as load_kbo_pitching_v2,
    load_kbo_fielding as load_kbo_fielding_v2,
    load_kbo_people as load_kbo_people_v2,
    load_npb_batting as load_npb_batting_v2,
    load_npb_pitching as load_npb_pitching_v2,
    load_npb_fielding as load_npb_fielding_v2,
    load_npb_people as load_npb_people_v2,
    load_mlb_batting,
    load_mlb_pitching,
    load_mlb_fielding,
    load_mlb_people,
