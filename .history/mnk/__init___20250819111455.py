...
from .mnk_merged.api import (
    load_mnk_batting,           # delete MLB records BUT keep the MLB_ID from Lahman
    load_mnk_pitching,          # delete MLB records BUT keep the MLB_ID from Lahman
    load_mnk_fielding,          # delete MLB records BUT keep the MLB_ID from Lahman
    load_mnk_people,            # delete MLB records BUT keep the MLB_ID from Lahman
    load_mnk_league,            # delete MLB records  BUT keep the MLB_ID from Lahman
    load_mnk_team,              # delete MLB records  BUT keep the MLB_ID from Lahman
    load_mnk_merged_people,     # delete MLB records  BUT keep the MLB_ID from Lahman
)
# package ---- current github repo
